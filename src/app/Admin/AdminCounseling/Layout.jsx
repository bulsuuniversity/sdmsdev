            ...
            <div className="flex justify-center">
                <div className="rounded-full md:bg-gray-400 grid gap-2 md:gap-0 sm:flex">
                    <Link href={"/Admin/AdminCounseling/SelfConsult"}
                        className={`sm:pl-4 px-1 sm:pr-2 py-2 hover:rounded-full hover:bg-amber-700 ${active === "/Admin/AdminCounseling/SelfConsult" ?
                    ...
                    <Link href={"/Admin/AdminCounseling/ReferConsult"}
                        className={`sm:pl-2 px-2 sm:pr-4 py-2 hover:rounded-full hover:bg-amber-700 ${active === "/Admin/AdminCounseling/ReferConsult" ?
                            "bg-amber-700 rounded-full text-white" : "bg-gray-400 rounded-full"}`}>

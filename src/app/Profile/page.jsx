    ...
    return (
        <Layout>
            <div className="bg-red-100 p-4">
                <div className="grid grid-cols-5 bg-red-50 items-center">
                    <div className="col-span-1">
                        <div className="relative ml-5 px-6">
                            ...
                            <div className="absolute z-10 mx-3 -top-6 -left-2 rounded-lg bg-orange-300">
                                <button className="text-2xl py-3 px-6">
                                    CHANGE PROFILE
                                </button>
                            </div>
                            <div className="absolute -top-16 left-7 overflow-hidden h-64 flex flex-col w-7/12 justify-center">
                    ...
                    <div className="col-span-4 text-2xl w-full p-2">
                        <div className="p-2">
                            ...
                            <div className="ml-4 font-medium">
                                ...
                                <div className="flex">  <label for="studentID">Email:</label>
